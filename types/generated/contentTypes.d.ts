...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Financial accounts (checking, savings, credit, investment)';
    displayName: 'Account';
    pluralName: 'accounts';
...
export interface ApiAssetAsset extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Financial assets (real estate, investments, vehicles, etc.)';
    displayName: 'Asset';
    pluralName: 'assets';
    singularName: 'asset';
  };
  ...
  attributes: {
    ...
    acquisitionValue: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.String &
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<
      ['real_estate', 'investment', 'vehicle', 'business', 'crypto', 'other']
    > &
      Schema.Attribute.Required &
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    icon: Schema.Attribute.String & Schema.Attribute.DefaultTo<'tag'>;
...
export interface ApiGoalGoal extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Financial goals (monthly or annual)';
    displayName: 'Goal';
    pluralName: 'goals';
    singularName: 'goal';
  };
  ...
  attributes: {
    ...
    icon: Schema.Attribute.String & Schema.Attribute.DefaultTo<'target'>;
    ...
    period: Schema.Attribute.Enumeration<['monthly', 'annual']> &
      Schema.Attribute.Required &
    ...
    targetAmount: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.DefaultTo<0>;
    type: Schema.Attribute.Enumeration<
      ['saving', 'expense_limit', 'income_target', 'debt_payment']
    > &
      Schema.Attribute.Required &
...
export interface ApiLiabilityLiability extends Struct.CollectionTypeSchema {
  collectionName: 'liabilities';
  info: {
    description: 'Financial liabilities (loans, mortgages, credit card debt, etc.)';
  ...
  attributes: {
    ...
    interestRate: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    minimumPayment: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
    ...
    originalAmount: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiRecurringExpenseRecurringExpense
  extends Struct.CollectionTypeSchema {
  collectionName: 'recurring_expenses';
  info: {
    description: 'Recurring expenses (subscriptions, rent, utilities)';
    displayName: 'RecurringExpense';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'monthly'>;
    icon: Schema.Attribute.String & Schema.Attribute.DefaultTo<'repeat'>;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    nextDueDate: Schema.Attribute.Date & Schema.Attribute.Required;
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    startDate: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSavingSaving extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Savings entries linked to accounts';
    displayName: 'Saving';
    pluralName: 'savings';
    singularName: 'saving';
  };
  ...
  attributes: {
    ...
    icon: Schema.Attribute.String & Schema.Attribute.DefaultTo<'piggy-bank'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::saving.saving'
    ...
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    targetAmount: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiSubscriptionSubscription
  ...
  info: {
    description: 'User subscription plans and billing info';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    paymentProvider: Schema.Attribute.Enumeration<['stripe', 'izipay']> &
      Schema.Attribute.DefaultTo<'stripe'>;
    plan: Schema.Attribute.Enumeration<['free', 'pro']> &
      Schema.Attribute.Required &
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    destinationAccount: Schema.Attribute.Relation<
      'manyToOne',
      'api::account.account'
    >;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    whatsappMessageId: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
  };
...
export interface ApiWhatsappBotWhatsappSession
  extends Struct.CollectionTypeSchema {
  collectionName: 'whatsapp_sessions';
  info: {
    description: 'Conversation sessions for WhatsApp bot users';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::whatsapp-bot.whatsapp-session'
    > &
      Schema.Attribute.Private;
    ...
    state: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'INIT'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::liability.liability': ApiLiabilityLiability;
      ...
      'api::whatsapp-bot.whatsapp-session': ApiWhatsappBotWhatsappSession;
